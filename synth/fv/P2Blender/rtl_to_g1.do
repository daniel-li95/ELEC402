...
usage -auto -elapse
set log file fv/P2Blender/rtl_to_g1.log -replace
tclmode
...
elaborate design -golden -root P2Blender -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/P2Blender/g1.v.gz
} else {
...
elaborate design -revised -root P2Blender
