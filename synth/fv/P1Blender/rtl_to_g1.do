...
usage -auto -elapse
set log file fv/P1Blender/rtl_to_g1.log -replace
tclmode
...
elaborate design -golden -root P1Blender -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/P1Blender/g1.v.gz
} else {
...
elaborate design -revised -root P1Blender
